...
namespace TankGame
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public static int forwardCamera = 1;
        public static Tank drawTank = tank; 
            ...
            if (keys.IsKeyDown(Keys.Space))
            {
                ...
                if (currentTime - tank.lastBulletTime > 500)
                {
                      Bullet newBullet = new Bullet(tank.tankPosition + Vector3.Transform(new Vector3(0, 0.17f, -0.05f),
                        tank.tankRotation), tank.tankRotation, 3f * speed / 60.0f, tank.num,tank.x,tank.y,tank.direction);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            DrawBricks(drawTank.tankPosition - drawTank.cameraPosition[i], drawTank.cameraUpDirection[i], 3);
            DrawCity();
            //if (i == 0)
